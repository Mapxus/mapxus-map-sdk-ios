...
static NSString * const kMXMPickerContainerCellReuseIdentifier =  @"MXMPickerContainerCell";

@interface MXMPickerContainerView() <UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@implementation MXMPickerContainerView
...
- (NSArray *)visibleItemViews
{
    ...
    [self.collectionView.visibleCells enumerateObjectsUsingBlock:^(__kindof MXMPickerContainerCell * _Nonnull cell, NSUInteger idx, BOOL * _Nonnull stop) {
        if (cell.customView) {
...
//    self.flowLayout.itemSize = CGSizeMake(self.frame.size.width, self.rowHeight);
    ...
    [self.collectionView registerClass:[MXMPickerContainerCell class] forCellWithReuseIdentifier:kMXMPickerContainerCellReuseIdentifier];
...
- (UIView *)viewForRow:(NSInteger)row
{
    ...
    MXMPickerContainerCell *cell = (MXMPickerContainerCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
    
    if (cell == nil) {
        [self.collectionView layoutIfNeeded];
        cell = (MXMPickerContainerCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
    }
...
{
    MXMPickerContainerCell *cell = (MXMPickerContainerCell *)[self.collectionView cellForItemAtIndexPath:[NSIndexPath indexPathForRow:row inSection:0]];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MXMPickerContainerCell *cell  = [collectionView dequeueReusableCellWithReuseIdentifier:kMXMPickerContainerCellReuseIdentifier forIndexPath:indexPath];
...
@implementation MXMPickerContainerCell
