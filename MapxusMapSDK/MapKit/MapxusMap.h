...
/// Initialisation function for `MapxusMap`.
///
/// @param mapView Binds `MGLMapView` as a map rendering tool.
...
///
/// @discussion 
/// The default value of this property is an MXMBorderStyle that evaluates
...
///
/// @discussion
/// If the `floorSwitchMode` is set to `MXMSwitchingByVenue`, buildings located on a different venue from the selected building will be masked.
...
/// Sets the general map appearance.
///
/// @param style Appearance type. Please refer to `MXMStyle` for specific attribute fields.
- (void)setMapSytle:(MXMStyle)style;


/// Sets up custom map appearance. You can contact us for map appearance customization.
///
/// @param styleName Appearance name
...
///
/// @discussion 
/// The map will be animated to zoom to that area with a margin of 0.
...
/// This method is used to add map annotations. If you need to add indoor points, you must call this method to layer them.
///
/// @param annotations This is a list of `MXMPointAnnotation`.
- (void)addMXMPointAnnotations:(NSArray<MXMPointAnnotation *> *)annotations;


/// This method is used to delete a map marker. If you need to delete an indoor point, you must call this method to delete it completely.
///
/// @param annotations This is a list of `MXMPointAnnotation`.
