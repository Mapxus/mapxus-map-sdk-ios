...
@interface MXMPickerTextRenderView()
...
@implementation MXMPickerTextRenderView
...
- (void)setupTextLabel
{
    ...
    _unselectedLabel.adjustsFontSizeToFitWidth = YES;
    ...
    _selectedLabel.adjustsFontSizeToFitWidth = YES;
