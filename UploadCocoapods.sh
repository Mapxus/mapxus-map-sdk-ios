...
# 分发根目录
DISTRIBUTION_ROOT_PATH="/mapxus-map-sdk-ios"
# 压缩文件名
ZIP_FILE='mapxus-map-sdk-ios.zip'
# 密码文件
ENV_FILE='nexus.env'
# cocoapods配置文件
PODSPEC_FILE='MapxusMapSDK.podspec'
# Package配置文件
PACKAGE_FILE='Package.swift'
# changelog文件名
CHANGELOG_FILE='CHANGELOG.md'
# 库名
TARGET_NAME='MapxusMapSDK'
...
if [[ -z $COM ]]; then
    ...
    ENV_FILE='nexus.env'
    # cocoapods配置文件
    PODSPEC_FILE='MapxusMapSDK-landsd.podspec'
    ...
    # cocoapods配置文件
    PODSPEC_FILE='MapxusMapSDK-jp.podspec'
